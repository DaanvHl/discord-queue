...
TOPICS = {
    ...
    "queue": (
        ...
        [
            ...
            ("/reset-captains", "Any player in the match can send it **back to captain selection** at any stage after lock-in (map ban, draft, auction, or in progress). From there you can re-pick captains or `/open` the queue."),
